...
;(function(root, factory) {
    ...
    var GUTILS = (function() {
        ...
        var TimeTest = (function() {
            ...
            TimeTest.prototype.end = function(label) {
        ...
        var REQUEST = (function() {
            ...
            var _xhr_request = function(params, callback) {
                ...
                if (callback === undefined) {
                    return new Promise(function(resolve, reject) {
                        _xhr_request(params, function(err, result) {
                ...
                var requestType = params.method || 'GET';
                var requestUrl = params.url;
                var requestAsync = params.async === false ? false : true;
                var requestData = params.body || null;
                var responseType = params.responseType || null;
            ...
            var _get_json = function (url, callback) {
                ...
                if (callback === undefined) {
                    return new Promise(function(resolve, reject) {
                        _get_json(url, function(err, result) {
                            if (err) { reject(err); } else { resolve(result); }
                        });
                    });
                }
        ...
        var TASK = (function() {
            ...
            // - cosa fare in caso di errore di una collback ? 
            return {
                parallel: parallel
            };
